...
export function SearchBar({
  ...
  return (
    <div className="relative">
      <Card className="p-6 transition-theme">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <FileText className="h-4 w-4" />
            <span className="font-medium">{fileName}</span>
          </div>
          <Button variant="outline" size="sm" onClick={onUploadNew} className="gap-2 transition-theme bg-transparent">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 pr-10 h-12 text-base transition-theme"
          />
          {searchQuery && (
            <Button
              variant="ghost"
              ...
              className="absolute right-2 top-1/2 transform -translate-y-1/2 h-8 w-8 p-0 transition-theme"
            >
              <X className="h-4 w-4" />
            </Button>
          )}
        ...
        {searchQuery && (
          <div className="mt-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Badge variant="secondary" className="gap-1 transition-theme">
              ...
              {totalMatches > 0 && (
                <div className="flex items-center gap-1">
                  <Button
                    ...
                    className="h-8 w-8 p-0 bg-transparent transition-theme"
      ...
      {searchQuery && totalMatches > 0 && (
        <div className="fixed top-4 right-4 z-50 bg-background/95 backdrop-blur-sm border rounded-lg shadow-lg p-3 transition-theme">
