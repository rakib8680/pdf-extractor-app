...
export function UploadZone({ onFileUpload, isProcessing }: UploadZoneProps) {
  ...
  return (
    <motion.div className="max-w-2xl mx-auto" variants={containerVariants} initial="hidden" animate="visible">
      <motion.div className="flex justify-center mb-6" variants={badgeVariants} initial="hidden" animate="visible">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-primary/20 to-primary/10 border border-primary/30 backdrop-blur-sm">
          ...
          <span className="text-sm font-medium text-primary">Free Beta Access</span>
        </div>
      </motion.div>
      ...
      <Card
        ...
        className={cn(
          ...
          isDragActive && "border-primary/80 bg-primary/15 shadow-2xl shadow-primary/40",
          ...
          {isProcessing ? (
            ...
            <>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3, duration: 0.6 }}>
                <h3 className="text-3xl md:text-4xl font-bold mb-3 flex items-center justify-center gap-3 text-foreground leading-tight">
                  <span>Upload</span>
                ...
                <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                  Drag and drop your PDF file here, or click to browse. Instant text extraction with powerful search
                  capabilities.
                </p>
